...
import com.example.viewsviewgroupsnintent.DummyData.facts

class FactAdapter(context: Context, list: List<FactModel>):
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        var  logo = view?.findViewById<ImageView>(R.id.imageLogo)
        var  name = view?.findViewById<TextView>(R.id.nameView)
